...
public class MockGenerationTest implements NSTServiceTestRunner {
    ...
    private static final String GENERATED_MOCK_PATH = RuntimeConfigManager.getInstance().getIosMocksLocation() + "/MockGenerationTest_exampleMockGenerationTest_0_GenericServiceWrapper.har";
