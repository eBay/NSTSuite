...
public class ListOfIntegerComponent extends BaseComponent {

  private DefaultListModel<String> listModel = new DefaultListModel<>();

  public ListOfIntegerComponent(JsonBaseType saveInstance, String jsonPath, String labelName, String labelDescription, JsonPathExecutor jsonPathExecutor, Method setterMethod, Method getterMethod) {
    ...
    controls.add(integerTextField, integerTextFieldConstraints);
