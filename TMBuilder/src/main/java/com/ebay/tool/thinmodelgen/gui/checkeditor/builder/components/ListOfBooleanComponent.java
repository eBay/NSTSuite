...
public class ListOfBooleanComponent extends BaseComponent {

  private DefaultListModel<String> listModel = new DefaultListModel<>();

  public ListOfBooleanComponent(JsonBaseType saveInstance, String jsonPath, String labelName, String labelDescription, JsonPathExecutor jsonPathExecutor, Method setterMethod, Method getterMethod) {
    ...
    // Add the add 'false' button
    GridBagConstraints addFalseButtonConstraints = new GridBagConstraints();
    addFalseButtonConstraints.gridx = 1;
    addFalseButtonConstraints.gridy = 0;
    addFalseButtonConstraints.weightx = 0.1;
    addFalseButtonConstraints.weighty = 1.0;
    addFalseButtonConstraints.insets = new Insets(2, 2, 2, 2);

    JButton addFalseButton = new JButton("Add 'False'");
    addFalseButton.addActionListener(new ActionListener() {
    ...
    controls.add(addFalseButton, addFalseButtonConstraints);

    // Add the add 'true' button
    GridBagConstraints addTrueButtonConstraints = new GridBagConstraints();
    addTrueButtonConstraints.gridx = 2;
    addTrueButtonConstraints.gridy = 0;
    addTrueButtonConstraints.weightx = 0.1;
    addTrueButtonConstraints.weighty = 1.0;
    addTrueButtonConstraints.insets = new Insets(2, 2, 2, 2);

    JButton addTrueButton = new JButton("Add 'True'");
    addTrueButton.addActionListener(new ActionListener() {
    ...
    controls.add(addTrueButton, addTrueButtonConstraints);
  ...
  private void updateModelInstance() {
    ...
    ArrayList<Boolean> saveData = new ArrayList<>();

    for (int i = 0; i < listModel.size(); i++) {
      String stringData = listModel.getElementAt(i);
      boolean data = Boolean.parseBoolean(stringData);
