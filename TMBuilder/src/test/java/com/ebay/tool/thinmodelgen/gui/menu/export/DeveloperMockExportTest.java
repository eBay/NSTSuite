...
//
//    @Test
//    public void populateNestedArraysInSamePath() throws Exception {
//        NodeModel model = getListOfStringNodeModel("stringNodeModel", "$.data.explore.ssms.hits.edges[*].node.gene_aa_change[*]", Arrays.asList("lorem ipsum"));
//        NodeModel[] nodeModels = new NodeModel[] {model};
//
//        ValidationSetModel validationSetModel = Mockito.mock(ValidationSetModel.class);
//        when(validationSetModel.getData()).thenReturn(nodeModels);
//
...
//        // We know the above is working correctly because of populateArrayPathToArraySizeMap().
//        // Build up the expected map.
//        List<Object> geneAaChange = new ArrayList<>();
//        geneAaChange.add(new Object());
//
//        TreeMap<String, Object> node = new TreeMap<>(new SmallestToLargestArrayPathComparator());
//        node.put("gene_aa_change", geneAaChange);
//
//        TreeMap<String, Object> edge = new TreeMap<>(new SmallestToLargestArrayPathComparator());
//        edge.put("node", node);
//
//        List<TreeMap<String, Object>> edges = new ArrayList<>();
//        edges.add(edge);
//
//        TreeMap<String, Object> hits = new TreeMap<>(new SmallestToLargestArrayPathComparator());
//        hits.put("edges", edges);
//
//        TreeMap<String, Object> ssms = new TreeMap<>(new SmallestToLargestArrayPathComparator());
//        ssms.put("hits", hits);
//
//        TreeMap<String, Object> explore = new TreeMap<>(new SmallestToLargestArrayPathComparator());
//        explore.put("ssms", ssms);
//
//        TreeMap<String, Object> data = new TreeMap<>(new SmallestToLargestArrayPathComparator());
//        data.put("explore", explore);
//
//        TreeMap<String, Object> root = new TreeMap<>(new SmallestToLargestArrayPathComparator());
//        root.put("data", data);
//
//        Gson gson = new Gson();
//        String actualJson = gson.toJson(actualMap);
//        String expectedJson = gson.toJson(root);
//
...
//
//    @Test
//    public void arrayPathElementRenderedInDuplicateBug() throws Exception {
//        NodeModel model = getListOfStringNodeModel("stringNodeModel", "$.data.explore.ssms.hits.edges[*].node.gene_aa_change[*]", Arrays.asList("lorem ipsum"));
//        NodeModel[] nodeModels = new NodeModel[] {model};
//
//        ValidationSetModel validationSetModel = Mockito.mock(ValidationSetModel.class);
...
//        JSONObject jsonObject = new JSONObject(actualMap);
//        String actualJson = jsonObject.toString();
//        String expectedJson = "{\"data\":{\"explore\":{\"ssms\":{\"hits\":{\"edges\":[{\"node\":{\"gene_aa_change\":[\"lorem ipsum\"]}}]}}}}}";
//        assertThat(actualJson, is(equalTo(expectedJson)));
//    }
//
//    // ---------------------------------
