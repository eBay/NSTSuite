...
public class KotlinThinModelExportTest {
    ...
    public void exportThinModel() throws ClassNotFoundException, IOException {
        ...
        String destinationFilePath = String.format("%s%s%s", currentWorkingDirectory, File.separator, "kotlinThinModelExportTest.java");

        String sourceFilePath = ResourceParser.getResourceFilePath("/com/ebay/tool/thinmodelgen/gui/menu/export/testOriginalKotlinFile.kt");
        ...
        String expectedFileContents = ResourceParser.readInResourceFile("/com/ebay/tool/thinmodelgen/gui/menu/export/testK.kt");
        ...
        kotlinThinModelExport.export(exportFile, validationSetModels);
    ...
    public void multipleExportsDoesNotIncreaseWhitespace() throws Exception {
        ...
        // Copy source file for editing by code generation, set it to delete on exit.
        String currentWorkingDirectory = System.getProperty("users.dir");
        String destinationFilePath = String.format("%s%s%s", currentWorkingDirectory, File.separator, "kotlinThinModelExportTest.kt");
    ...
    public void lowerCaseCamelCaseValidationSetName(String input, String expected) {
        KotlinThinModelExport export = new KotlinThinModelExport();
