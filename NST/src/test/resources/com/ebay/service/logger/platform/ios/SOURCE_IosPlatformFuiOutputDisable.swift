...
class SimpleCheckoutExampleTest : ServiceTestBase {
    ...
    func test_iosPlatformFuiOutputDisable() {
        
        // AUTO GENERATED MOCK INJECTION CODE BLOCK - DO NOT MODIFY CONTENTS
        inject(responses: [
            "CheckoutModule.EnterCheckoutRequest_1": "IosFuiTestLoggerTest_iosPlatformFuiOutputDisable_1_EnterCheckout.har",
            "CheckoutModule.PurchaseCheckoutRequest_2": "IosFuiTestLoggerTest_iosPlatformFuiOutputDisable_2_PurchaseCheckout.har"
            ])
