...
class SimpleCheckoutExampleTest : ServiceTestBase {
	...
	func test_additionalOperationStatementAdded() {
		...
		inject(responses: [
			"CheckoutModule.EnterCheckoutRequest_1": "IosFuiTestLoggerTest_additionalOperationStatementAdded_1_EnterCheckout.har",
			"CheckoutModule.SetPaymentRequest_2": "IosFuiTestLoggerTest_additionalOperationStatementAdded_2_SetPayment.har",
			"CheckoutModule.PurchaseCheckoutRequest_3": "IosFuiTestLoggerTest_additionalOperationStatementAdded_3_PurchaseCheckout.har"
			])
