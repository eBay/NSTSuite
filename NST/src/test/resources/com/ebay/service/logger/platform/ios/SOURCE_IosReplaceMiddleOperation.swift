...
class SimpleCheckoutExampleTest : ServiceTestBase {
	...
	let middleOperation = MiddleOperation()
	...
	func test_replaceTheMiddleOperation() {
		...
		inject(responses: [
			...
			"CheckoutModule.SetPaymentRequest_2": "IosReplaceMiddleOperation_replaceTheMiddleOperation_2_MiddleOperation.har",
		...
		// AUTO GENERATED METHOD CODE BLOCK - DO NOT MODIFY CONTENTS
		// CORRESPONDING API CALL: MiddleOperation
		// OPERATION INDEX: 2
		middleOperation.navigateTo()
		validate(middleOperation)
		// END OF AUTO GENERATED METHOD CODE BLOCK
		
		middleOperation.validate()
