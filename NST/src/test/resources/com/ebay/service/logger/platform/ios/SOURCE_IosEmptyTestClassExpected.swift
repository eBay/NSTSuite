...
class SimpleCheckoutExampleTest : ServiceTestBase {
	...
	func test_firstTest() {
		...
		inject(responses: [
			"CheckoutModule.EnterCheckoutRequest_1": "IosEmptyTestClass_firstTest_1_EnterCheckout.har",
			"CheckoutModule.PurchaseCheckoutRequest_2": "IosEmptyTestClass_firstTest_2_PurchaseCheckout.har"
			])
