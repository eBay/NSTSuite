...
class SimpleCheckoutExampleTest : ServiceTestBase {
	...
	func test_firstTest() {
		...
		inject(responses: [
			"CheckoutModule.EnterCheckoutRequest_1": "IosFuiTestLoggerTest_addOperationsToEmptyMethod_1_EnterCheckout.har",
			"CheckoutModule.PurchaseCheckoutRequest_2": "IosFuiTestLoggerTest_addOperationsToEmptyMethod_2_PurchaseCheckout.har"
			])
