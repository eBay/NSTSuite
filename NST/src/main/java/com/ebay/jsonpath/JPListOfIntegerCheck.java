...
public class JPListOfIntegerCheck implements JsonPathExecutor, NullCheck<JPListOfIntegerCheck>, Serializable {

  /**
   *
   */
  private static final long serialVersionUID = 194222875233230176L;
  ...
  private List<Integer> expectedValues = null;

  private List<Integer> containsValues = null;
   ...
   * are not null.
   */
  public JPListOfIntegerCheck() {

  }

  /**
   * Make sure each value in the list of Integers equal the specified value.
   *
   * @param value
   *          Expected Integer value to match against all values.
   * @return Current instance.
   */
  public JPListOfIntegerCheck hasAllValuesEqualTo(Integer value) {
   ...
   * @return Current instance.
   */
  public JPListOfIntegerCheck hasLength(Integer length) {
   ...
   * @return Current instance.
   */
  public JPListOfIntegerCheck hasMinLength(Integer length) {
   ...
   * @return Current instance.
   */
  public JPListOfIntegerCheck hasMaxLength(Integer length) {
    this.maxLength = length;
    return this;
  }

  /**
   * Make sure the list of Integers equals (index value and order) the specified
   * values.
   *
   * @param values
   ...
   * @return Current instance.
   */
  public JPListOfIntegerCheck isEqualTo(List<Integer> values) {
   ...
   * @return Current instance.
   */
  public JPListOfIntegerCheck contains(List<Integer> values) {
   ...
   */
  public List<Integer> getIsEqualToValues() {
   ...
   */
  public List<Integer> getContainsValues() {
   ...
   */
  public Integer getAllExpectedValue() {
  ...
  public void processJsonPath(String jsonPath, SoftAssert softAssert, DocumentContext documentContext) {
    ...
    try {
      ...
      softAssert.fail(AssertMessageBuilder.build(jsonPath, String.format("as it was unable to be cast to list of Integer. Original message: %s", e.getMessage())));
      return;
