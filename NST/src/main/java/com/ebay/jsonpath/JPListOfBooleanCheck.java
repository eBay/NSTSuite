...
public class JPListOfBooleanCheck implements JsonPathExecutor, NullCheck<JPListOfBooleanCheck>, Serializable {
  ...
  private List<Boolean> expectedValues = null;
   ...
   * are not null.
   */
  public JPListOfBooleanCheck() {

  }

  /**
   * Make sure each value in the list of Booleans equal the specified value.
   *
   * @param value
   *          Expected Boolean value to match against all values.
   * @return Current instance.
   */
  public JPListOfBooleanCheck hasAllValuesEqualTo(Boolean value) {
   ...
   * @return Current instance.
   */
  public JPListOfBooleanCheck hasLength(Integer length) {
   ...
   * @return Current instance.
   */
  public JPListOfBooleanCheck hasMinLength(Integer length) {
   ...
   * @return Current instance.
   */
  public JPListOfBooleanCheck hasMaxLength(Integer length) {
    this.maxLength = length;
    return this;
  }

  /**
   * Make sure the list of Booleans equals (index value and order) the specified
   * values.
   *
   * @param values
   ...
   * @return Current instance.
   */
  public JPListOfBooleanCheck isEqualTo(List<Boolean> values) {
  ...
  /**
   * Make sure the list of Booleans contains the specified values.
   *
   * @param values
   *          Values that the list of Booleans is expected to contain.
   * @return Current instance.
   */
  public JPListOfBooleanCheck contains(List<Boolean> values) {
   ...
   */
  public List<Boolean> getIsEqualToValues() {
   ...
   */
  public List<Boolean> getContainsValues() {
   ...
   */
  public Boolean getAllExpectedValue() {
  ...
  public void processJsonPath(String jsonPath, SoftAssert softAssert, DocumentContext documentContext) {
    ...
    try {
      ...
      softAssert.fail(AssertMessageBuilder.build(jsonPath, String.format("as it was unable to be cast to list of Boolean. Original message: %s", e.getMessage())));
      return;
    ...
    for (int i = 0; i < values.size(); i++) {
      ...
      try {
        ...
        softAssert.fail(AssertMessageBuilder.build(jsonPath, String.format("as it was unable to be cast to Boolean. Original message: %s", e.getMessage())));
        continue;
      }
